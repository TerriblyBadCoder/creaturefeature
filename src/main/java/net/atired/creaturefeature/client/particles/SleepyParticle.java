...
public class SleepyParticle extends TextureSheetParticle {
    ...
    protected SleepyParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed,SpriteSet sprite) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SleepyParticle flameparticle = new SleepyParticle(level, x, y, z, xSpeed, ySpeed, zSpeed,sprite);
