...
public class GlassSinisterParticle extends TextureSheetParticle {
    float addToAngle = 0.0f;
    boolean bounced=false;
    SpriteSet spr;
    protected GlassSinisterParticle(ClientLevel clientWorld, double d, double e, double f, SpriteSet spriteProvider, double xd, double yd, double zd) {
...
//            this.gravity-=0.05f;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            GlassSinisterParticle flameparticle = new GlassSinisterParticle(level, x, y, z,sprite, xSpeed, ySpeed, zSpeed);
