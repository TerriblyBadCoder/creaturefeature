...
public class SpitParticle extends TextureSheetParticle {
    ...
    protected SpitParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprite) {
    ...
    public void tick() {
        ...
        this.quadSize+=Math.max(1.0f-aged*10.0f,0.0f)/7.0f;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SpitParticle flameparticle = new SpitParticle(level, x, y, z, xSpeed, ySpeed, zSpeed,sprite);
