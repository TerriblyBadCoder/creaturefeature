...
public class MurkyPearlEntityRenderer extends EntityRenderer<MurkyPearlEntity> {
    private static final float MIN_CAMERA_DISTANCE_SQUARED = 12.25F;
    private static final ResourceLocation BLANK_LOCATION = CreatureFeature.getId("textures/entity/pearl_trail.png");

    private final ItemRenderer itemRenderer;
    private final float scale;
    private final boolean fullBright;

    public MurkyPearlEntityRenderer(EntityRendererProvider.Context context, float scale, boolean fullBright) {
        super(context);
    ...
    protected int getBlockLightLevel(MurkyPearlEntity entity, BlockPos pos) {
        return this.fullBright ? 15 : super.getBlockLightLevel(entity, pos);
    }

    public void render(MurkyPearlEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public boolean shouldRender(MurkyPearlEntity livingEntity, Frustum camera, double camX, double camY, double camZ) {
        return true;
    }
    ...
    public ResourceLocation getTextureLocation(MurkyPearlEntity entity) {
