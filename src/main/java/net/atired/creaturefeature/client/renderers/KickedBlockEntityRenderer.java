...
import net.atired.creaturefeature.entity.KickedBlockEntity;
...
public class KickedBlockEntityRenderer extends EntityRenderer<KickedBlockEntity> {
    private final BlockRenderDispatcher dispatcher;

    private static final ResourceLocation CRIT_LOCATION = CreatureFeature.getId("textures/entity/crit.png");

    public KickedBlockEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.dispatcher = context.getBlockRenderDispatcher();
    }

    @Override
    public void render(KickedBlockEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        if(entity.state!=null){
            ...
            poseStack.pushPose();
            float aged = (entity.tickCount+partialTick)/12.0f;
            float scaleAge = Math.min(1.0f,aged);
            ...
            for (int i = 0; i < 4; i++) {
                ...
                VertexConsumer consumer = bufferSource.getBuffer(RenderType.itemEntityTranslucentCull(CRIT_LOCATION));
                ...
                consumer = bufferSource.getBuffer(CFRenderTypes.entityAmbushCutout(CRIT_LOCATION));
                vertex(pose,consumer,dir1.x,dir1.y,dir1.z,0,0,vector3f.x,-1,vector3f.z,255,scaleAge*0.33f);
                vertex(pose,consumer,dir2.x,dir2.y,dir2.z,1,0,vector3f.x,-1,vector3f.z,255,scaleAge*0.33f);
                vertex(pose,consumer,dir3.x,dir3.y,dir3.z,1,1,vector3f.x,-1,vector3f.z,255,scaleAge*0.33f);
                vertex(pose,consumer,dir4.x,dir4.y,dir4.z,0,1,vector3f.x,-1,vector3f.z,255,scaleAge*0.33f);
    ...
    @Override
    public ResourceLocation getTextureLocation(KickedBlockEntity entity) {
