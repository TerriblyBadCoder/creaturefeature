...
void main() {
    ...
    float noisy = abs(cnoise(vec3(fracted*sized/2f,0)/8.0+vec3(Revealness,GameTime*1600.0,0.0)));
    float noisy2 = abs(cnoise(vec3(fracted*sized/2f,900)/8.0+vec3(Revealness,GameTime*1600.0,0.0)));
    color *= ColorModulator;
    vec3 verCol2 = vertexColor.rgb;
    verCol2.r-=fract(verCol2.r*12f)/12f;
    verCol2.g-=fract(verCol2.g*12f)/12f;
    verCol2.b-=fract(verCol2.b*12f)/12f;
